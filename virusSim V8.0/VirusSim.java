...
public class VirusSim {
    ...
    public VirusSim() throws Exception{
        ...
        System.out.println("enter how long people are infected for");
        int infectedTime = input.nextInt();
        System.out.println("enter how long people are immune for after they are cured");
        int immuneTime = input.nextInt();
